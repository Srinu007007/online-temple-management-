...
<table class="table" style="border:1px solid black;">
  <thead>
    <tr>
      ...
      <th scope="col">Darshanarthi(Devotee) Name</th>
	  <th scope="col">Darshanarthi(Devotee) Email</th>
 <th scope="col">Darshanarthi(Devotee) Mobile Number</th>
  ...
  <tbody>
    <tr>
      ...
      <td>srinu@gamil.com</td>
		<td>8712388818</td>
		<td>not yet</td>
		<td><a href="viewbookingdetails.php" class="btn btn-primary btn-sm">View Detail</a></td>
    </tr>
