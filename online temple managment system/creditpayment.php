...
<form class="credit-card" action="bill.php" method="POST">
  ...
  <div class="form-body">
    ...
    <!-- Buttons -->
	<input type="submit" class="proceed-btn" name="credit" value="Proceed">
