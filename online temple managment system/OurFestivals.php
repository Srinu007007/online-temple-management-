...
<!-- our Festivals -->
<hr>
<h3 style="text-align:center;"> Our Festivales </h3>
<div class="container">
	<div class="row">
		<div class="col-lg-3">

				<img src="img/p6.jpg"  style="border:1px solid black;padding:5px;margin-top:30px;border-radius:10px;"width="350" height="310" border="0" alt="">
		</div>
		<div class="col-lg-8">
<!-- sub creation-->
		<div class="row">
			...
			<p style="margin-left:80px;text-align:justify;">Tirupati (/ˈtɪrʊpɒtɪ/ (listen)) is a city in the Indian state of Andhra Pradesh. It is the administrative headquarters of the Tirupati district. Located 415 km (258 mi) southwest of state's capital Amaravati, the city is home to the important Hindu shrine of Tirumala Venkateswara Temple and other historic temples and is referred to as the "Spiritual Capital of Andhra Pradesh".[8] It is one of the eight Swayam vyaktha kshetras (Self-Manifested Temples)</p><br>
